...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const firebaseConfig = {
        apiKey: "AIzaSyCGRt2iRVEOkf5h0u7jkWQP_6NAF8Wp9fE",
        authDomain: "st-studio-music.firebaseapp.com",
        projectId: "st-studio-music",
        storageBucket: "st-studio-music.appspot.com",
        messagingSenderId: "154672076560",
        appId: "1:154672076560:web:765afc05ea5e4ef1a2b795"
      };
